...
<Container>
      ...
      <Typography variant="body1" color="white" sx={{ mt:1,mb:1 }}>
        ...
        first block of Jirón Camaná. It here the remains of Santa Rosa de Lima.
      </Typography>
      <Typography variant="body1" color="white" sx={{ mt:1,mb:1 }}>
        ...
        then we will make a short stop to taste the famous Turrón de doña pepa.
      </Typography>
      <Typography variant="body1" color="white" sx={{ mt:1,mb:1 }}>
        Our next point will be the San Francisco convent. Inside it has a museum
        where it preserves and exhibits one of the most representative
        historical and artistic collections of Peruvian colonials virreinal art.
      </Typography>
      <Typography variant="body1" color="white" sx={{ mt:1,mb:1 }}>
        As a main point our Cathedral of Lima, which is the biggest in Peru. In
        front of the Plaza de armas Lima whose around it is the municipality of
        lima and the government palace. we will have a moment to take pictures
      ...
      <Typography variant="body1" color="white" sx={{ mt:1,mb:1 }}>
        And our last point will be La Iglesia de la Virgen Milagrosa Located in
        the Central Park of Miraflores, it was designed by the architect Ricardo
        de Jaxa Malachowski and built on the basis of the old church called San
        Miguel de Miraflores.
      </Typography>
      </Container>
    </Container>
  );
